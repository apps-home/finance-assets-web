...
function NavigationMenuLink({
	...
	return (
		<Comp
			...
			className={cn(
				"flex items-center gap-2 in-data-[slot=navigation-menu-content]:rounded-sm rounded-md p-2 text-xs outline-none transition-all hover:bg-muted focus:bg-muted focus-visible:outline-1 focus-visible:ring-1 focus-visible:ring-ring/50 data-active:bg-muted/50 data-active:focus:bg-muted data-active:hover:bg-muted [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		/>
